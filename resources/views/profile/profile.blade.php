...
<section class="lk-section">
    <div class="referral-link">
        ...
        <div class="referral-link__col">
            ...
            <div class="input-row"><input class="input-row__input input input--accent2" value="{{ !empty(getPartnerArray()) ? (getPartnerArray()['phone'] ?? getPartnerArray()['email']) ?? 'undefined' : __('you don\'t have upliner') }}" type="text"/>
            </div>
        </div>
    </div>
